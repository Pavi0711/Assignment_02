...
- text: Name
- textbox "Name": TestProduct1760704343648
- text: SKU
- textbox "SKU": TP1760704343648
- text: Price
- textbox "Price": Electronics
- text: USD Weight
- textbox "Weight": "0.30"
...
- alert: "Exception in middleware createProduct: Price should be a number with maximum 2 decimal places"
- button "close"
```