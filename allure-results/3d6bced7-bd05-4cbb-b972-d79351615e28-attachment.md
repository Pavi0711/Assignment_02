...
- textbox [disabled]
- textbox
- paragraph: Login/Sign up
- paragraph: Work Email
- text: Forgot Login Id?
- textbox "Enter your work email id": test@example.com
- text: CONTINUE
- paragraph: OR USE YOUR BUSINESS ACCOUNT WITH
- iframe
- paragraph:
  - text: By proceeding, you agree to MakeMyTrip's
  - link "Terms of use":
    - /url: https://www.makemytrip.com/legal/mybiz-tnc/terms-of-use.html
  - text: ","
  - link "Terms of services":
    - /url: https://www.makemytrip.com/legal/mybiz-tnc/terms-of-service.html
  - text: and
  - link "Privacy":
    - /url: https://www.makemytrip.com/legal/privacy_policy.html
- img "img1"
- paragraph: Business Travel Solutions
- paragraph: TAILORED FOR YOU.
- list:
  - listitem:
    - paragraph: Smart Dashboard
    - paragraph: Real-time Reporting & Analytics
  - listitem:
    - paragraph: Seamless Integrations
    - paragraph: ERP, HRMS & SSO Integrations
  - listitem:
    - paragraph: Policy Compliance
    - paragraph: Easy Setup with Automated/Quick Approvals
- paragraph
- img "credit-card"
...
- text: Departure
- textbox "Departure 19 Sep'25 Friday": Thursday, 18 Sep 2025
- paragraph: 19 Sep'25
- paragraph: Friday
- text: Return
...
- checkbox
- text: Add FlexiFly 100% refund on cancellation or Zero date change charges View Details
- paragraph: Search
- main:
  - main:
    - text: Explore More
    ...
    - paragraph: "LIVE NOW: Up to 25% OFF*"
    - paragraph: on your international trips!
    - text: Book Now
    - paragraph: INTL FLIGHTS
    - paragraph: "LIVE NOW: Sale by Air India Express"
    - paragraph: with Fares Starting @ ₹1,599*.
    - text: Explore Now
    - paragraph: HOLIDAYS T&C's Apply
    - paragraph: "#EldersFirst Travel Experiences are Here!"
    - paragraph: Explore senior-friendly packages with on-trip medical support & more.
    - text: Book Now
    - paragraph: INTL FLIGHTS T&C's Apply
    - paragraph: Introducing Price Lock Pro
    - paragraph: Lock Prices for Multiple Flights, Pay Just One Fee.
    - text: BOOK NOW
    - paragraph: CABS T&C's Apply
    - paragraph: "Festive Deals: Up to 15% OFF*"
    - paragraph: on Buses, Cabs & Trains!
    - text: "Code: MMTFESTIVE BOOK NOW"
    - paragraph: DOM FLIGHTS T&C's Apply
    - paragraph: "LIVE NOW: Sale by IndiGo!"
    - paragraph: with flight fares starting @ ₹1,299*.
    - text: Book Now
    - button "Next"
    ...
    - list: CGH Earth Experience Hotels The Ascott Limited Majestic Hotels
    - button "Previous"
...
- contentinfo:
  ...
  - list:
    ...
    - listitem: redBus Columbia,
    - listitem: redBus Peru,
    - listitem: redBus Indonesia,
  ...
  - list:
    ...
    - listitem: Austria Visa,
    - listitem: Azerbaijan Visa,
    - listitem: Bangladesh Visa,
    - listitem: Bahrain Visa,
    - listitem: Cambodia Visa,
    - listitem: China Visa,
    - listitem: Czech Republic Visa,
    - listitem: Dubai - UAE Visa,
    - listitem: Egypt Visa,
    - listitem: Finland Visa,
    - listitem: France Visa,
    - listitem: Georgia Visa,
    - listitem: Germany Visa,
    - listitem: Greece Visa,
    - listitem: Hong Kong Visa,
    - listitem: Iceland Visa,
    - listitem: Indonesia Visa,
    - listitem: Ireland Visa,
    - listitem: Italy Visa,
    - listitem: Japan Visa,
    - listitem: Kenya Visa,
    - listitem: Malaysia Visa,
    - listitem: Morocco Visa,
    - listitem: Netherlands Visa,
    - listitem: New Zealand Visa,
    - listitem: Norway Visa,
    - listitem: Portugal Visa,
    - listitem: Qatar Visa,
    - listitem: Russia Visa,
    - listitem: Singapore Visa,
    - listitem: South Africa Visa,
    - listitem: South Korea Visa,
    - listitem: Spain Visa,
    - listitem: Sri Lanka Visa,
    - listitem: Sweden Visa,
    - listitem: Switzerland Visa,
    - listitem: Thailand Visa,
    - listitem: United Kingdom - UK Visa,
    - listitem: Uzbekistan Visa,
    - listitem: Vietnam Visa,
    - listitem: Mongolia Visa,
    - listitem: Zambia Visa
